...
def load_parts_dataset(vehicle_type):
    ...
    if vehicle_type == "car":
        return pd.read_csv(os.path.join(data_dir, "car_parts_cost_master.csv"), header=None, names=columns)
    elif vehicle_type == "bike":
        return pd.read_csv(os.path.join(data_dir, "bike_parts_cost_master.csv"), header=None, names=columns)
    elif vehicle_type == "scooty":
        return pd.read_csv(os.path.join(data_dir, "scooty_parts_cost_master.csv"), header=None, names=columns)
    else:
