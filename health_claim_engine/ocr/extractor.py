...
from groq import Groq  # CHANGED: Import Groq instead of google.generativeai
...
# CONFIG
# -------------------------------
DIR_PATH = "C:\\Users\\Rahul\\Documents\\Project\\PICT\\Claim Automation\\OCR\\S0004-06142005000900015-1"  # default, will be overridden
...
def check_consistency_with_groq(text1, text2, doc_type):  # CHANGED: Renamed function
    # Configure Groq Client
    client = Groq(api_key=API_KEY)  # CHANGED: Use Groq client
...
if __name__ == "__main__":
    ...
    if "discharge_summary" in extracted:
        ...
        for tt in text_types:
            if tt in documents:
                ...
                result = check_consistency_with_groq(discharge_text, other_text, tt)
    ...
    output_path = Path(OUTPUT_DIR) / f"extracted_data_{dir_name}.json"
